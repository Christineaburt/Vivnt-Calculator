...
function App() {
  ...
  const getHomeSizePercentage = (value) => {
    const percentages = { '<1000': 0, '1000-2000': 33.33, '2000-3000': 66.66, '>3000': 100 };
    return percentages[value] || 33.33;
  };
        ...
        <div className="calculator-page">
          <div className="calculator-container">
            <button onClick={resetCalculator} className="reset-link">
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5F7775" strokeWidth="2">
